define(function(require) {
	require('zepto');
	var downloadapp=new (require('downloadapp'));
	COMPONENTS=new (require('components'));
	AJAXMY=new(require('ajaxMy'));
	$(document).on("click", ".app_download_wrap", function () {
        downloadapp.openApp({
