define(function(require) {
	...
	var myPaging=new paging("#paging",MAXPAGING,function(currentPage){
		AJAXMY.send('/certification/list',{page:currentPage,size:PERPAGINGCOUNT},function(d){
			...
			$.each(d['result'],function(k,v){
				...
				s+='<tr><td>'+v['userId']+'</td><td>'+v['nickName']+'</td><td>'+applyType+'</td><td>'+parseString.MSToYMDHMS(v['applyTime'])+'</td><td>'+status+'</td><td  class="td_reason">'+replayDom+'</td><td data-id="'+v['id']+'"><button class="glyphicon-details glyphicon onlyicon" title="查看详情"></button> '+sOperate+'</td></tr>';
			});
